...
import 'package:movie_app_flutter/services/api_services.dart';
                ...
                : searchModel ==null
                  ...
                  : GridView.builder(
                    ...
                    itemBuilder: (context, index){
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>MovieDetailScreen(movieId: searchModel!.results[index].id),),);
                        },
                        child: Column(
                          children: [
                            searchModel!.results[index].backdropPath == null 
                            ? Image.asset("assets/popcorn.png", height: 170) 
                            : CachedNetworkImage(
